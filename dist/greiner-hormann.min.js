...
this.j=0;this.f=!0;this.e=this.a=!1}function m(a,c,b,d){a=new k(a);c=new k(c);return a.clip(c,b,d)}Array.isArray=Array.isArray||function(a){return Boolean(a&&"[object Array]"===Object.prototype.toString.call(Object(a)))};h.l=function(a,c,b){a=new h(a,c);a.j=b;a.a=!0;a.f=!1;return a};h.prototype.o=function(){this.e=!0;null===this.d||this.d.e||this.d.o()};h.prototype.b=function(a){return this.x===a.x&&this.y===a.y};h.prototype.n=function(a){var c=!1,b=a.first,d=b.next,e=this.x,g=this.y;do(b.y<g&&d.y>=
g||d.y<g&&b.y>=g)&&(b.x<=e||d.x<=e)&&(c^=b.x+(g-b.y)/(d.y-b.y)*(d.x-b.x)<e),b=b.next,d=b.next||a.first;while(!b.b(a.first));return c};n.prototype.valid=function(){return 0<this.toSource&&1>this.toSource&&0<this.i&&1>this.i};k.prototype.g=function(a){if(null==this.first)this.first=a,this.first.next=a,this.first.c=a;else{var c=this.first,b=c.c;c.c=a;a.next=c;a.c=b;b.next=a}};k.prototype.m=function(a,c,b){for(;!c.b(b)&&c.j<a.j;)c=c.next;a.next=c;b=c.c;a.c=b;b.next=a;c.c=a};k.prototype.h=function(a){for(;a.a;)a=
