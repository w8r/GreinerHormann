...
b^=g;c^=f;do d.a&&(d.f=b,b=!b),d=d.next;while(!d.b(this.first));do e.a&&(e.f=c,c=!c),e=e.next;while(!e.b(a.first));for(a=[];this.r();){b=this.q();c=new k([]);c.g(new h(b.x,b.y));do{b.o();if(b.f){do b=b.next,c.g(new h(b.x,b.y));while(!b.a)}else{do b=b.c,c.g(new h(b.x,b.y));while(!b.a)}b=b.d}while(!b.e);a.push(c)}0===a.length&&(g&&a.push(this),f&&a.push(this));return a};return{union:function(a,b){return m(a,b,!1,!1)},intersection:function(a,b){return m(a,b,!0,!0)},diff:function(a,b){return m(a,b,!1,
!0)}}}"function"===typeof define&&define.s?define([],l):"object"===typeof exports?module.exports=l():window.greinerHormann=l();
